...
<div class="container mt-5">
    ...
    <form action="${pageContext.request.contextPath}/NotificationUpdateServlet" method="post" class="mb-3">
    ...
    <%
        ...
        String userEmail = (String) sess.getAttribute("employeeEmail");

        Connection conn = DBConection.getConnection();
        PreparedStatement ps = conn.prepareStatement(
            "SELECT n.id, n.message, n.status, n.created_at FROM notifications n JOIN users u ON n.user_id = u.id WHERE u.mail = ? AND n.status='unread' ORDER BY n.id DESC"
        );
            ...
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <% if ("unread".equalsIgnoreCase(status)) { %>
                        <form action="${pageContext.request.contextPath}/NotificationUpdateServlet" method="post">
