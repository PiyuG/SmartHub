...
<div class="profile-dropdown" id="profileDropdown">
    <ul>
        <li onclick="showLoaderAndNavigate('<%= request.getContextPath() %>/jsp_pages/employee/profile.jsp')"><i class="fas fa-user"></i><p>Profile</p><span>></span></li>
        <li onclick="window.location.href='<%= request.getContextPath() %>/jsp_pages/employee/logout.jsp'"><i class="fas fa-sign-out-alt"></i><p>Logout</p><span>></span></li>
    </ul>
</div>
<div class="notification-dropdown" id="notificationDropdown" >
    <ul>
        <li onclick="showLoaderAndNavigate('<%= request.getContextPath() %>/jsp_pages/employee/notification.jsp')">View All Notifications</li>
    </ul>
</div>
