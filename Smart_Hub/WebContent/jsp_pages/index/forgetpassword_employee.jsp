...
<%@ include file="header.jsp" %>
    <section class="resetpassword-section">
        <div class="resetpassword-container">
            ...
            <form action="${pageContext.request.contextPath}/ResetPasswordEmployeeServlet" method="post">
            ...
            <div class="employee-info">
                <p>Back to Login <a href="<%= request.getContextPath() %>/jsp_pages/index/employeelogin.jsp">Click here</a></p>
            </div>
        </div>
    </section>
</body>
