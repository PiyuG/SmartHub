    ...
    <section class="registration-section">
        <div class="registration-container">
			    ...
			    <script>
			        ...
			        setTimeout(function() {
			            ...
			            <% if ("success".equals(messageType)) { %>
			                window.location.href = "<%= request.getContextPath() %>/jsp_pages/index/customerlogin.jsp";
			            <% } %>
			        }, 3000);
			    </script>
			<% } %>
            ...
            <div class="registration-info">
                <p>Already have an account? <a href="<%= request.getContextPath() %>/jsp_pages/index/customerlogin.jsp">Login here</a></p>
            </div>
        </div>
    </section>
