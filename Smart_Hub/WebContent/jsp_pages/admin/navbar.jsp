...
<div class="profile-dropdown" id="profileDropdown">
    <ul>
        <li onclick="window.location.href='<%= request.getContextPath() %>/jsp_pages/admin/logout.jsp'"><i class="fas fa-sign-out-alt"></i><p>Logout</p><span>></span></li>
    </ul>
</div>
<div class="notification-dropdown" id="notificationDropdown">
    <ul>
        <li onclick="showLoaderAndNavigate('<%= request.getContextPath() %>/jsp_pages/admin/new_order.jsp')"><i class="fas fa-box"></i> New order received</li>
        <li onclick="showLoaderAndNavigate('<%= request.getContextPath() %>/jsp_pages/admin/lowStock.jsp')"><i class="fas fa-exclamation-circle"></i> Product stock low</li>
    </ul>
</div>
